...
export function RepoCard({name, description, language, stargazers_count, html_url}: Repo) {
    return (
        <div className="my-4 w-72 sm:w-105 md:w-135 lg:w-175 lg:flex lg:justify-between bg-[#151d29] border border-[#30363d] rounded-lg">
            <div className="text-center flex flex-col gap-2 my-2 lg:py-2">
                ...
                <p className="text-[#8b949e] text-sm px-4">{description ? description : "There is no description for this repo"}</p>
